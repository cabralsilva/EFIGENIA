...
<!--     GRÁFICOS -->
	...
	<link href="<?= BaseProjeto ?>resources/template3/assets/plugins/flot/examples/examples.css" rel="stylesheet" />
		...
		<div class="subnavbar-inner">
			...
			<div class="container">
				...
				<ul class="mainnav">
					...
					<li class="active"><a href="<?= BaseSite ?>dashboard"> <i class="icon-dashboard"></i> <span>Dashboard</span>
					</a></li>
					<li></li>
		...
		<div class="footer-inner">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="span12">
						&copy; 2017 . All Rights Reserved. <br>Desenvolvido por <a href="#" target="_blank">LDW Engenharia e Tecnologia</a>.
					</div>
					<!-- /span12 -->
...
<!-- 	GRÁFICOS -->
	<!-- GLOBAL SCRIPTS -->
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/jquery-2.0.3.min.js"></script>
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
	<!-- END GLOBAL SCRIPTS -->

	<!-- PAGE LEVEL SCRIPTS -->
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/flot/jquery.flot.js"></script>
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/flot/jquery.flot.resize.js"></script>
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/flot/jquery.flot.time.js"></script>
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/flot/jquery.flot.symbol.js"></script>
	<script src="<?= BaseProjeto ?>resources/template3/assets/plugins/flot/jquery.flot.crosshair.js"></script>
	<script src="<?= BaseProjeto ?>resources/template3/assets/js/line_chart.js"></script>
